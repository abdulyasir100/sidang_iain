...
<head>
    ...
    <title>@yield('title','Beranda Akademik Biro')</title>
...
<nav class="navbar navbar-dark bg-primary">
  <a class="navbar-brand" href="{{ url('/berandaakademikbiro') }}">
  ...
  <div class="row">
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-2" style="min-height: calc(100vh - 50px)">
        <ul class="nav nav-pills mb-auto flex-column">
            <li class="nav-item">
                <a class="nav-link link-dark text-dark" href="{{ url('/berandaakademikbiro') }}">
