...
<body>
    <nav class="navbar navbar-dark bg-primary">
        <a class="navbar-brand" href="{{ url('/berandamahasiswa') }}">
            <img src="{{ asset('image/assets/logo_iain.png') }}" height="40" class="d-inline-block align-top"
                style="float:left" alt="">
            <h3 style="padding-left:10px float:right">IAIN PADANGSIDIMPUAN</h3>
        </a>
        <div class="text-white ms-auto">
            Anda login sebagai {{ Session::get('nama') }} | Status : {{ Session::get('status') }}
    ...
    <div class="row">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light col-2" style="min-height: calc(100vh - 50px)">
            <ul class="nav nav-pills mb-auto flex-column">
                <li class="nav-item">
                    <a class="nav-link link-dark text-dark" href="{{ url('/berandamahasiswa') }}">
