@extends('layout.layoutakademikbiro')
@section('title','Beranda Akademik Biro')
@section('content')
        ...
        <div class="row">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @else
                    <td  colspan="4"><p class="text-center font-weight-bold mt-3">Tidak ada file yang tersedia</p></td>
                    @endif
                </tbody>
                <script>
